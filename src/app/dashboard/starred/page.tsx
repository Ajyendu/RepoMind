    ...
    return (
        <div className="space-y-8">
            ...
            {starredRepos.length === 0 ? (
                <div className="rounded-3xl bg-white border border-black shadow-[0_10px_24px_rgba(15,23,42,0.06)] p-12 flex flex-col items-center justify-center text-center space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {starredRepos.map((repo) => (
                        <div
                            key={repo.full_name}
                            className="p-6 rounded-2xl bg-white border border-black shadow-[0_10px_24px_rgba(15,23,42,0.06)] hover:border-black transition-colors group flex flex-col justify-between"
                        >
                            <div>
