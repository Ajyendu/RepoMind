    ...
    return (
        <main className="min-h-screen bg-white text-black">
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <section className="bg-white border border-black rounded-2xl p-8 md:p-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-100 border border-black text-black text-xs font-semibold uppercase tracking-wide mb-5">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <Link
                            ...
                            className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-black text-white font-bold border border-black hover:bg-neutral-800 transition-colors"
                        >
    ...
    return (
        <main className="min-h-screen bg-white text-black">
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <header className="mb-12 border-b border-gray-200 pb-8">
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                        <div className="w-full">
                            <h1 className="font-display text-4xl md:text-5xl tracking-tight mb-4 text-black">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap gap-4 mt-10">
                        <Link
                            ...
                            className="inline-flex items-center justify-center px-6 py-3.5 border border-black text-sm font-medium rounded-xl text-white bg-black hover:bg-neutral-800 transition-colors"
                        >
                ...
                <section className="bg-white border border-black rounded-xl p-8 mb-12">
                    ...
                    <div className="mt-8">
                        <Link
                            href={`/chat?q=${owner}/${repo}`}
                            className="text-amber-700 hover:text-black font-medium inline-flex items-center group"
                        >
                ...
                {shouldRenderReadmePreview && fullReadme && (
                    <section className="bg-white border-2 border-black p-8 mb-12">
                        <div className="flex items-center justify-between border-b-2 border-black pb-2 mb-6">
                            <h2 className="text-xs font-bold tracking-[0.16em] uppercase text-black">Repository Summary (README)</h2>
                        </div>

                        <div className="prose prose-gray max-w-none prose-img:inline prose-img:m-0 prose-img:mr-1 prose-img:align-middle prose-p:leading-relaxed prose-a:text-black hover:prose-a:underline prose-headings:font-semibold prose-h1:text-3xl prose-h2:text-2xl text-gray-800">
                            <ReactMarkdown
