...
import { parseGitHubInput } from "@/lib/parse-github-input";
...
export function ReportContent({
    ...
    const handleLaunchDeepScanAnotherRepo = () => {
        const parsed = parseGitHubInput(deepScanRepoInput);
        if (parsed.kind !== "repo") {
            toast.error("Use owner/repo or a GitHub URL");
            return;
        }
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 p-4 md:p-8 selection:bg-black selection:text-white">
            <div className="max-w-4xl mx-auto space-y-8">
                <div data-testid="report-actions-navbar" className="print:hidden">
                    <div className="rounded-2xl border border-black bg-white p-4 shadow-xl md:hidden">
                    ...
                    <div className="hidden md:block sticky top-0 z-50 rounded-2xl border border-black bg-white p-4 md:p-5 shadow-xl">
                ...
                <div className="rounded-2xl border border-black bg-white p-6 shadow-xl">
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                        <div className="space-y-3">
                            ...
                            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-600">
                                ...
                                <span className={`rounded-md border px-2 py-0.5 text-xs ${isOutdated ? "border-red-500/20 bg-red-500/10 text-red-700" : "border-amber-500/20 bg-amber-500/10 text-black"}`}>
                        ...
                        <div className="print:hidden flex flex-col gap-3 lg:items-end">
                            <Link
                                ...
                                className="inline-flex items-center justify-center gap-2 rounded-lg border border-black bg-black px-3.5 py-2 text-sm font-medium text-white transition-all hover:bg-neutral-800"
                            >
                                <Shield className="w-4 h-4" />
                                Repository Profile
                            </Link>
                ...
                <div className="rounded-2xl border border-black bg-white p-6 space-y-4">
                ...
                <div className="space-y-6">
                    <div className="rounded-2xl border border-black bg-white p-6 space-y-4">
                        ...
                        {topFixesByFingerprint.length === 0 ? (
                            <div className="rounded-xl border border-black bg-gray-50 p-4 text-sm text-gray-600">
                    ...
                    {findingViews.length === 0 ? (
                        <div className="rounded-xl border border-black bg-gray-50 p-8 text-center">
                ...
                <div className="no-export pt-8 text-center text-sm text-zinc-600">
                    <p>Generated by <a href={baseUrl} className="font-semibold text-black hover:underline"><ProductName className="text-sm" /></a> — The AI developer sidekick.</p>
                </div>
            </div>
