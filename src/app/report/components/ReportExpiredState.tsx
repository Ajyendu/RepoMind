...
export function ReportExpiredState({ owner, repo, expiresAt }: ReportExpiredStateProps) {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 flex items-center justify-center p-6">
            <div className="max-w-lg w-full rounded-2xl border border-black bg-white p-8 space-y-4">
                ...
                <div className="flex items-center gap-2">
                    <Link
                        href={rerunHref}
                        className="inline-flex items-center px-4 py-2 bg-black text-white hover:bg-neutral-800 transition-colors text-sm font-medium"
                    >
                        Rescan in Repo Chat
                    </Link>
                    <Link
