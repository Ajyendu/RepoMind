            ...
            return (
                <div className="space-y-3 font-sans text-sm leading-relaxed text-gray-800">
                    ...
                    <motion.div
                        ...
                        className="mt-4 bg-white p-3 rounded-lg border border-black border-l-4 border-l-black"
                    >
            ...
            return (
                <div className="space-y-3 font-sans text-sm leading-relaxed">
                    ...
                    <motion.div
                        ...
                        className="mt-4 bg-gray-50 overflow-hidden rounded-lg border border-black"
                    >
                        {/* Mock Flowchart UI */}
    ...
    return (
        <section ref={containerRef} className="py-10 md:py-12 px-4 relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center">
            <div className="text-center mb-8">
                <h2 className="font-display text-3xl md:text-4xl mb-3 text-black">
                    See it in Action
                </h2>
                <p className="text-neutral-600 text-base md:text-lg font-medium mb-6 max-w-xl mx-auto">
                    Watch how RepoMind answers questions, generates architecture diagrams, and runs security checks — try the arrows or dots to switch scenarios.
                </p>
                <div className="flex items-center justify-center gap-6 mb-4">
                    <button
                        onClick={() => handleManualSwitch('prev')}
                        className="p-1.5 hover:bg-black hover:text-white rounded-full text-gray-600 transition-colors border-2 border-transparent hover:border-black"
                    ...
                    <div className="flex gap-2">
                        {scenarios.map((_, idx) => (
                            <button
                                ...
                                className={`h-1.5 rounded-full transition-all duration-500 ${idx === scenarioIndex ? "w-8 bg-black" : "w-3 bg-gray-400 hover:bg-gray-500"}`}
            ...
            <div className="w-full relative overflow-hidden bg-white border-2 border-black  min-h-[380px] flex flex-col">
                {/* macOS window top bar */}
                <div className="flex items-center px-3 py-2 bg-white border-b-2 border-black transition-colors duration-500">
                ...
                <div className="p-4 md:p-6 space-y-4 min-h-[340px] flex-1 overflow-hidden flex flex-col">
                    ...
                    <div className="flex gap-4 items-start w-full flex-row-reverse">
                        <div className="bg-black border-2 border-black p-4 w-full text-white font-mono text-sm relative">
                                ...
                                <div className="flex-1 space-y-4">
                                    ...
                                    >
                                        {currentScenario.tags.map((tag, i) => {
                                            ...
                                            return (
                                                <span key={i} className="flex items-center gap-1.5 text-xs bg-white border border-black text-gray-800 px-2 py-1 rounded-md font-medium">
                                    ...
                                    <div className="bg-white border border-black p-5 rounded-2xl rounded-tl-none w-full text-gray-800 shadow-sm relative overflow-hidden">
                                        {/* Dynamic accent line */}
