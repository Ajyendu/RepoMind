    ...
    return (
        <section className="w-full py-16 relative z-10">
            <div className="max-w-4xl mx-auto px-4">
                <div className="bg-white border border-black rounded-xl p-8 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl shadow-slate-900/10">
                    ...
                    <div className="flex gap-6 items-center flex-1 relative z-10">
                        <div className="w-16 h-16 rounded-full bg-black border border-black flex items-center justify-center shrink-0">
                    ...
                    <div className="shrink-0 bg-white border border-black rounded-xl px-5 py-3 flex items-center justify-center gap-2 relative z-10 m-auto md:m-0 w-full md:w-auto">
