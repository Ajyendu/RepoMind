...
export default function RecentScans({ userId, limit, showViewAll = false }: { userId?: string; limit?: number; showViewAll?: boolean }) {
    ...
    if (loading) {
        return (
            <div className="rounded-3xl bg-white border border-black shadow-[0_10px_24px_rgba(15,23,42,0.06)] p-12 flex flex-col items-center justify-center space-y-4">
    ...
    return (
        <motion.div
            ...
            className="rounded-3xl bg-white border border-black shadow-[0_10px_24px_rgba(15,23,42,0.06)] overflow-hidden flex flex-col"
        >
                                    ...
                                    <div className="flex items-center gap-3 text-xs text-gray-600">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            {scan.summary.medium > 0 && (
                                                <span className="text-black">{scan.summary.medium} Med</span>
                                            )}
                                            {scan.summary.low > 0 && (
