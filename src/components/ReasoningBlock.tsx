        ...
        return (
            <div className="not-prose select-none flex min-h-10 items-center">
                <div className="flex items-center gap-2">
                    <span className="text-xs font-semibold uppercase tracking-widest text-black/80">
                        Thinking
                    </span>
        ...
        <div className="mb-2 not-prose select-none">
            ...
            >
                <div className="flex items-center gap-2 shrink-0">
                    <span className="text-xs font-semibold uppercase tracking-widest text-black/80 group-hover:text-black transition-colors">
            ...
            <AnimatePresence>
                {isExpanded && hasRealThoughts && (
                    ...
                    >
                        <div className="mt-2 space-y-3 pl-3 border-l border-black">
