    ...
    if (linkMeta.type === "preview") {
        return (
            <button
                ...
                className="text-black hover:text-purple-300 hover:underline inline-flex items-center gap-1 cursor-pointer bg-transparent border-none p-0 font-mono text-sm"
