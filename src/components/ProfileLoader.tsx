    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-white text-gray-900 gap-4 p-4">
                ...
                <Link href="/" className="mt-4 px-6 py-3 bg-black text-white font-bold border border-black rounded-lg hover:bg-neutral-800 transition-colors">
                    Back to Home
                </Link>
            </div>
        );
                    ...
                    <div className="mb-8 text-center">
                        ...
                        >
                            <Image
                                ...
                                width={96}
                                height={96}
                                className="w-24 h-24 rounded-2xl border border-black shadow-lg"
                                unoptimized
                            />
                        </motion.div>
