...
export function ProfileChatInterface({ profile, profileReadme, repoReadmes }: ProfileChatInterfaceProps) {
    ...
    return (
        <div className="flex flex-col h-[100dvh] bg-white text-gray-900">
            {/* Profile Header */}
            <div className="border-b-2 border-black p-4 md:p-6 bg-white">
                <div className="flex items-start gap-3 md:gap-6 max-w-3xl mx-auto">
                    ...
                    <img
                        ...
                        alt={profile.login}
                        className="w-10 h-10 md:w-20 md:h-20 rounded-xl border border-black"
                    />
                    <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap md:flex-nowrap items-center gap-2 md:gap-3 mb-2">
                            ...
                            <div className={cn(
                                ...
                                tokenWarningLevel === 'safe' && "bg-white text-gray-600 border border-black"
                            )}>
                            ...
                            <div className={cn(
                                ...
                                {(msg.role === "user" || msg.content || (msg.modelUsed !== "thinking" && loading && msg.id === messages[messages.length - 1]?.id)) && (
                                    ...
                                    >
                                        ...
                                        <div className={cn(
                                            "prose prose-sm max-w-none leading-relaxed break-words overflow-hidden w-full min-w-0",
                                            msg.role === "user"
                                                ? "text-white prose-invert prose-p:text-white prose-li:text-white prose-strong:text-white"
