...
export function CopyBadge({ owner, repo }: CopyBadgeProps) {
    ...
    return (
        <div className="flex flex-col gap-4 p-6 bg-white border border-black shadow-[0_10px_24px_rgba(15,23,42,0.06)] rounded-2xl w-full">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-600 mt-0.5">Showcase RepoMind&apos;s analysis directly in your repository&apos;s README.</p>
                    </div>
                </div>
                <button
                    onClick={handleCopy}
