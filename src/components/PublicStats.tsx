...
export default function PublicStats() {
    ...
    if (!stats) {
        return (
            <div className="flex flex-wrap justify-center gap-4 mt-8 md:mt-12 text-sm text-gray-600 font-medium">
                <div className="flex items-center gap-2 bg-white border border-black px-4 py-2 rounded-lg shadow-md shadow-slate-900/10 animate-pulse">
    ...
    return (
        <div className="flex flex-wrap justify-center gap-4 mt-8 md:mt-12 text-sm text-gray-700 font-medium">
            <div className="flex items-center gap-2 bg-white border border-black px-4 py-2 rounded-lg shadow-md shadow-slate-900/10">
