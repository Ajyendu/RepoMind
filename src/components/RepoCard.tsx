...
export function RepoCard({ name, owner, description, stars, forks, language }: RepoCardProps) {
    return (
        ...
        >
            <div className="relative bg-white border border-black rounded-xl p-5 shadow-[0_8px_24px_rgba(15,23,42,0.06)] hover:border-purple-600/50 transition-all duration-300">
