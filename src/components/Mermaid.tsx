    ...
    return (
        <>
            ...
            >
                <div
                    ref={diagramRef}
                    className="overflow-x-auto bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex justify-center min-w-0"
                ...
                {!isGenerating && svg && (
                    <div className="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-all">
                        <button
                            onClick={exportToPNG}
                            className="p-2 bg-white border border-black text-black hover:bg-[#111111] hover:text-white hover:border-[#111111] rounded-lg shadow-sm transition-colors"
                            title="Export as PNG"
                        >
                ...
                {showOverlay && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/95 backdrop-blur-sm rounded-xl border border-gray-200 z-10">
                        <div className="flex items-center gap-2 text-gray-600">
                            <Sparkles className="w-5 h-5 animate-pulse text-[#111111]" />
                ...
                {error && !isFixing && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/98 backdrop-blur-sm rounded-xl border border-gray-200 p-4 text-center z-10">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-white border border-black text-black hover:bg-[#111111] hover:text-white hover:border-[#111111] rounded-lg text-sm transition-colors flex items-center gap-2"
                        >
                ...
                {isModalOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative w-full max-w-[95vw] max-h-[95vh] bg-white rounded-2xl border border-gray-200 shadow-2xl overflow-hidden flex flex-col"
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-white">
                                ...
                                <div className="flex items-center gap-2">
                                    {!isGenerating && svg && (
                                        <button
                                            onClick={exportToPNG}
                                            className="p-2 hover:bg-[#111111] hover:text-white rounded-lg text-black transition-colors"
                                            title="Export as PNG"
                                        >
                            ...
                            {/* Content */}
                            <div className="flex-1 overflow-auto bg-white relative custom-scrollbar diagram-modal-content">
                                <style>{`
