    ...
    return (
        <section id="cag-comparison" className="py-12 md:py-16 px-4 relative overflow-hidden">
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                >
                    <h2 className="font-display text-3xl md:text-5xl mb-6 text-black">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white border-2 border-black p-8 cursor-default flex flex-col hover:bg-neutral-50 transition-colors">
                    ...
                    <div className="bg-white border-2 border-black p-8 relative overflow-hidden hover:bg-neutral-50 transition-colors cursor-default flex flex-col">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-black/30 blur-[50px] rounded-full" />

                        <div className="flex items-center gap-3 mb-6 relative z-10">
                            <div className="p-3 bg-black text-white border-2 border-black rounded-lg">
                                <Brain className="w-6 h-6 text-white" />
                            </div>
                            <h3 className="text-2xl text-gray-900"><ProductName className="text-2xl" /> <span className="font-semibold">(Agentic CAG)</span></h3>
                        </div>
                        ...
                        <div className="w-full h-48 bg-white rounded-xl mb-8 relative overflow-hidden flex items-center justify-center border-2 border-black shadow-inner z-10">
                            ...
                            <motion.div
                                className="absolute w-16 h-16 bg-black text-white border-2 border-black rounded-full flex items-center justify-center font-mono text-xs font-bold"
                            ...
                            {[...Array(5)].map((_, i) => {
                                ...
                                return (
                                    <Fragment key={`node-group-${i}`}>
                                        ...
                                        <motion.div
                                            key={`node-${i}`}
                                            className="absolute w-8 h-8 bg-black text-white border-2 border-black rounded flex items-center justify-center text-[8px] font-mono"
                            ...
                            <motion.div
                                className="absolute bottom-4 left-4 text-xs font-mono text-white bg-black px-2 py-1 rounded border-2 border-black"
                                initial={{ opacity: 0 }}
                        ...
                        <div className="space-y-4 flex-1 relative z-10">
                            <div className="flex items-start gap-3">
                                <div className="mt-0.5 p-1 bg-black rounded-full shrink-0 border-2 border-black">
