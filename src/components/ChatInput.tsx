...
export function ChatInput({
    ...
    return (
        <div className="relative group/input max-w-4xl mx-auto">
            ...
            <div className="relative flex items-end bg-white border-2 border-black p-2 focus-within:ring-2 focus-within:ring-black">
                <textarea
                    ref={textareaRef}
                    value={value}
                ...
                <div className="flex items-center gap-1.5 pb-1 pr-2" ref={dropdownRef}>
                    <div className="relative">
                        <button
                            ...
                            className={cn(
                                ...
                                modelPreference === "flash"
                                    ? "bg-white border-gray-200 text-gray-700 hover:bg-black hover:text-white"
                                    : "bg-amber-50 border-amber-200 text-black hover:bg-amber-100",
                                disabled && "opacity-50 cursor-not-allowed"
                            )}
                        >
                            {modelPreference === "flash" ? (
                        ...
                        <AnimatePresence>
                            {showModelDropdown && (
                                <motion.div
                                    ...
                                    className="absolute bottom-full right-0 mb-4 w-52 bg-white backdrop-blur-2xl border border-black rounded-2xl shadow-xl overflow-hidden z-50 p-1.5 flex flex-col gap-1"
                                >
                                    <button
                                        type="button"
                                        onClick={() => {
                                        ...
                                        className={cn(
                                            ...
                                            modelPreference === "flash" ? "bg-black text-white" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                                        )}
                                    >
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-purple-500/10 flex items-center justify-center border border-black">
                    ...
                    >
                        <div className={cn(
                            ...
                            !disabled && value.trim() ? "bg-black text-white border border-black hover:scale-105 active:scale-95 shadow-md" : "bg-gray-200 text-gray-400 opacity-50 shadow-none border border-black"
                        )}>
