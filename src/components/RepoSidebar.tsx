    ...
    return (
        <>
            ...
            <div className={cn(
                ...
                <div className="shrink-0 p-3 border-t-2 border-black flex items-center justify-center bg-white">
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="bg-white border border-gray-200 rounded-xl w-full max-w-md shadow-2xl overflow-hidden flex flex-col max-h-[80vh]">
                        ...
                        <div className="p-4 border-t border-gray-200 bg-gray-50">
                            <button
                                onClick={() => setShowHiddenFiles(false)}
                                className="w-full py-2 bg-black hover:bg-neutral-800 text-white font-medium border border-black rounded-lg transition-colors text-sm"
                            >
                                Close
                            </button>
                        </div>
