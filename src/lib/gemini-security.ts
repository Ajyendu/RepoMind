import { getGenAI, getDefaultModel, isGoogleSearchEnabled } from "./ai-client";
...
function getSecurityThinkingGenerationConfig(): GenerationConfig | undefined {
    return undefined;
}
...
`;
        ...
        const model = getGenAI().getGenerativeModel({
            ...
            tools: isGoogleSearchEnabled() ? [{ googleSearchRetrieval: {} }] : [],
